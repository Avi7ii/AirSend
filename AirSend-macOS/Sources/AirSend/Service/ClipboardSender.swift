...
actor ClipboardSender {
    ...
    private func internalSendImage(imageData: Data, to device: Device, scheme: String) async throws {
        ...
        let infoDto = RegisterDto(alias: alias, version: "2.4", deviceModel: deviceModel, deviceType: deviceType.rawValue, fingerprint: myFingerprint, port: 53317, protocolType: localProtocol.rawValue, download: true)
