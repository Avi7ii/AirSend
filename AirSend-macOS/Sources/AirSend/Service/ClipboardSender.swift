...
actor ClipboardSender {
    ...
    private func internalSendImage(imageData: Data, to device: Device, scheme: String) async throws {
        ...
        let infoDto = RegisterDto(alias: alias, version: "3.5.0", deviceModel: deviceModel, deviceType: deviceType.rawValue, fingerprint: myFingerprint, macAddress: LocalNetworkIdentity.primaryHardwareAddress(), port: Int(NetworkPorts.transferPort), protocolType: localProtocol.rawValue, download: true)
