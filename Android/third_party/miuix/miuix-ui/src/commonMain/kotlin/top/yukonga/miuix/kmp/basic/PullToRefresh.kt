        ...
        return (
            object : NestedScrollConnection {
                ...
                override fun onPreScroll(available: Offset, source: NestedScrollSource): Offset {
                    ...
                    // Keep the content interactive while the refresh indicator is visible.
                ...
                override fun onPostScroll(consumed: Offset, available: Offset, source: NestedScrollSource): Offset {
                    // The child remains responsible for scrolling during an active refresh.
                    if (refreshState == RefreshState.Refreshing || refreshState == RefreshState.RefreshComplete) {
                        return Offset.Zero
                    }
...
private fun createPullToRefreshConnection(
    ...
    override fun onPreScroll(available: Offset, source: NestedScrollSource): Offset {
        when (pullToRefreshState.refreshState) {
            ...
            RefreshState.RefreshComplete, RefreshState.Refreshing -> {
                return topAppBarScrollBehavior?.nestedScrollConnection?.onPreScroll(available, source) ?: Offset.Zero
            }
    ...
    override fun onPostScroll(consumed: Offset, available: Offset, source: NestedScrollSource): Offset {
        when (pullToRefreshState.refreshState) {
            RefreshState.RefreshComplete, RefreshState.Refreshing -> {
                return topAppBarScrollBehavior?.nestedScrollConnection?.onPostScroll(consumed, available, source) ?: Offset.Zero
            }
    ...
    override suspend fun onPreFling(available: Velocity): Velocity {
        if (pullToRefreshState.refreshState == RefreshState.Refreshing ||
